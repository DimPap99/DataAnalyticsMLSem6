...
#del superv_features['SP(t)']
#del superv_features['DAX(t)']
#del superv_features['FTSE(t)']
#del superv_features['NIKEEI(t)']
#del superv_features['BOVESPA(t)']
#del superv_features['EU(t)']
#del superv_features['EM(t)']

#superv_features = pd.concat([superv_features, temp.drop(columns=['USD ISE(t)'])], axis=1)
print(superv_ise)
